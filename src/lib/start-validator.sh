...
--identity /mt/solana/testnet-validator-keypair.json \
--vote-account /mt/solana/vote-account-keypair.json \
--log /mt/solana/solana-validator/log/solana-validator.log \
