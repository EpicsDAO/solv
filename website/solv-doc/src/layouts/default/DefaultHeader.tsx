    ...
    <>
      ...
      >
        ...
        >
          {({ close }) => (
            <>
              <div className="flex items-center justify-between p-6 xl:justify-start xl:space-x-10">
                ...
                <div className="hidden items-center justify-end gap-3 xl:flex xl:w-0 xl:flex-1">
                  <LanguageChanger />
                  <ColorModeChanger />
                  <a
              ...
              >
                <Popover.Panel
                  focus
                  className="absolute inset-x-0 top-0 origin-top-right transform bg-white p-2 transition dark:bg-gray-900 xl:hidden"
                >
